...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2019 a las 16:59:52
...
CREATE TABLE `recuperaciones` (
  ...
  `url_secreta` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `fecha` date NOT NULL
...
CREATE TABLE `usuarios` (
  ...
  `correoE` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `password` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `genero` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `fechaN` date NOT NULL,
  `biogra` varchar(255) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
